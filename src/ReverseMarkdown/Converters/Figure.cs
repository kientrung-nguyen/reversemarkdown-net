...
{
    public class Figure : ConverterBase
    {
        public Figure(Converter converter) : base(converter)
        {
        ...
        public override string Convert(HtmlNode node)
        {
            ...
            do
            {
                if (node.ChildNodes.Count == 1 && node.FirstChild.Name == "figure")
                {
            ...
            // if there is a block child then ignore adding the newlines for figure
